...
class PointDisc:
    def __init__(self, num_comp, recursion_steps, load, store, path: str):
        """
        ...
        # needed for store and load
        self.path = os.path.join(path, str(self.num_comp) + "_" + str(self.recursion_steps))
        if not os.path.isdir(self.path):
            os.mkdir(self.path)

        self.filename = self.path + "//" + str(self.num_comp) + "_" + str(self.recursion_steps)
